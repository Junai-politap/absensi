<nav class="sb-topnav navbar navbar-expand navbar-light" style="background-color: #8CCDC2">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3 mt-2 "><img src="{{ url('public') }}/asset/lg-ti.png" class="img-circle mb-2" alt=""
                ...
                <li>
                    <div class="row">
                        <div class="col-md-12 text-center pt-3">
                            <img src="{{ url('public') }}/asset/profile.jpg" class="rounded-circle mx-auto "
